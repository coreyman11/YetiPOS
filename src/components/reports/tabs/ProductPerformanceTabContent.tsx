...
interface ProductPerformanceTabContentProps {
  report: ProductPerformanceReport;
}

export const ProductPerformanceTabContent: React.FC<ProductPerformanceTabContentProps> = ({ report }) => {
  return (
        ...
        <Card className="overflow-hidden bg-gradient-to-br from-white to-[#F6F6F7] shadow-sm">
          ...
          <CardContent>
            {report.lowPerformers.length > 0 ? (
              <div className="h-72">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={report.lowPerformers}>
                    <CartesianGrid strokeDasharray="3 3" stroke={CHART_STYLES.gridColor} />
                    <XAxis 
                      dataKey="name" 
                      tick={{ fill: CHART_STYLES.axisColor }}
      ...
      <Card className="overflow-hidden bg-gradient-to-br from-white to-[#F6F6F7] shadow-sm">
        ...
        <CardContent>
          <Table>
            ...
            <TableBody>
              {[...report.topPerformers, ...report.lowPerformers]
